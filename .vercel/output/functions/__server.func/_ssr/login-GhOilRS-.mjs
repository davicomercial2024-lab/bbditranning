...
import { r as loginFn, t as BrandLogo } from "./auth.functions-BNA8SXrM.mjs";
import { t as Route } from "./login-B5QskuYm.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/login-GhOilRS-.js
...
function LoginPage() {
	...
	async function handleSubmit(event) {
		...
		setError("");
		try {
			const destination = getRedirectPath((await loginFn({ data: {
				email,
				password
			} })).role, redirect);
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(BrandLogo, { className: "mx-auto h-auto w-full max-h-44 object-contain" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "Alunos usam o e-mail cadastrado pelo admin."
					})]
				}),
