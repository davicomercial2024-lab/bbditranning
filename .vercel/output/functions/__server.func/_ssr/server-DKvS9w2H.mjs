import "../_runtime.mjs";
import { C as isResolvedRedirect, E as isNotFound, O as invariant, S as isRedirect, T as rootRouteId, a as RouterProvider, b as resolveManifestAssetLink, t as renderRouterToStream, x as executeRewriteInput } from "../_libs/@tanstack/react-router+[...].mjs";
...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-CR8RRGrf.mjs";
import { a as require_react, o as require_jsx_runtime } from "../_libs/react+tanstack__react-query.mjs";
import { i as requestHandler, r as getResponse } from "./request-response-DKbRKVw6.mjs";
require_react();
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-BjxIaJ3F.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Cr-e8Dv5.mjs"),
		import("./start-C3rliUbN.mjs"),
