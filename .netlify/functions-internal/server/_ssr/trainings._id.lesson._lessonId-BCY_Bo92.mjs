...
import { D as ChevronRight, E as CircleCheck, M as ArrowLeft, O as ChevronLeft, x as ExternalLink } from "../_libs/lucide-react.mjs";
import { c as usePortalData, s as useLessonProgress, t as PortalShell } from "./portal-data-Cxlz1458.mjs";
import { t as Route } from "./trainings._id.lesson._lessonId-B_Yx2r6c.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/trainings._id.lesson._lessonId-BCY_Bo92.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
function QuizPlayer({ questions, onPass }) {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					lesson.type === "text" && !textLooksLikeHtml && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("article", {
						className: "p-8 text-sm leading-relaxed whitespace-pre-wrap text-foreground break-words overflow-wrap-anywhere",
						children: contentSource.replace(/\u00A0/g, " ")
					}),
			...
			lesson.type !== "quiz" && !isSingleLessonTraining && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircleCheck, { className: "h-4 w-4" }), lessonCompleted ? "Aula concluída" : "Marcar aula como concluída"]
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mt-6 flex items-center justify-between gap-3 border-t border-border/60 pt-6",
				children: [
