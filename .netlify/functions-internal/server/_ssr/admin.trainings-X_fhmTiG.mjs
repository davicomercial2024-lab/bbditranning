...
import { N as ArrowDown, j as ArrowUp, l as Plus, o as Trash2, u as Pencil } from "../_libs/lucide-react.mjs";
import { c as usePortalData, t as PortalShell } from "./portal-data-Cxlz1458.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/admin.trainings-X_fhmTiG.js
...
function AdminTrainings() {
	...
	function moveUp(index) {
		...
		items[index] = temp;
		reorderTrainings(items.map((t, i) => ({
			id: t.id,
			order: i
		})));
	}
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
					...
					children: trainings.map((training, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("tr", {
								...
								children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
									...
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
											...
											disabled: index === 0,
											className: "h-8 w-8 grid place-items-center rounded-md hover:bg-accent disabled:opacity-30",
